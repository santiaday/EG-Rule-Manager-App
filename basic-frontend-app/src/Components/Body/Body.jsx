    ...
    files.map((file) => {
      if (
        (JSON.stringify(file.originFile) !==
          JSON.stringify(settings[0].originFile) ||
          JSON.stringify(file.targetFile) !==
            JSON.stringify(settings[1].targetFile) ||
  ...
  return (
    <Container style={{ width: "90vw", maxWidth: "85vw" }}>
      ...
      <Typography className={classes.subTitle} variant="h5">
        Upload the files that you would like to be converted here. 
      </Typography>
      <br />
      <br />
          ...
          >
            ...
            {allFilesConverted == 1 ? (
              ...
              <Button
                ...
                style={{
                  background: !isHovering2 ? "#000099" : "#00006A",
                  transition: "background 0.15s ease-in-out",
                  color: "white",
                  border: !isHovering2 ? "2px solid #000099" : "2px solid #00006A",
            ...
            <Button
              ...
              style={{
                background: !isHovering ? "rgba(56, 55, 55)" : "#000000",
                border: !isHovering ? "2px solid rgba(56, 55, 55)" : "2px solid #000000",
                transition: "background 0.15s ease-in-out",
                color: "white",
                minWidth: "120px",
      ...
      {confirmUpdatePopup == 1 ? (
        <>
          <ConfirmUpdatePopup
            setConfirmUpdatePopup={setConfirmUpdatePopup}
            confirmUpdatePopup={confirmUpdatePopup}
